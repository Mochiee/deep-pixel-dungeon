...
public class Bestiary {
	...
	private static Class<?> mobClass( int depth ) {
		...
		switch (depth) {
		case 1:
			chances = new float[]{ 0, 0, 0, 1, 0, 0};
			classes = new Class<?>[]{ Dummy.class, Shadow.class, Idol.class, Sludge.class, Eye.class, DarkRat.class};
			break;
		case 2:
			chances = new float[]{ 0, 0, 0, 1 };
			classes = new Class<?>[]{ Dummy.class, Gnoll.class, Shadow.class, Idol.class };
			break;
		case 3:
			chances = new float[]{ 5, 0, 0, 0, 5, 5};
			classes = new Class<?>[]{ Dummy.class, Gnoll.class, Crab.class, Swarm.class, Idol.class, Shadow.class };
			break;
		case 4:
			chances = new float[]{ 5, 5, 5, 5, 5, 0f };
			classes = new Class<?>[]{ Rat.class, Yog.class, Shadow.class, Idol.class,  Albino.class, Thief.class };
			break;
