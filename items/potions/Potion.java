...
import com.mochi.deeppixeldungeon.items.ItemStatusHandler;
...
public class Potion extends Item {
	...
	private static final Class<?>[] potions = {
			...
			PotionOfMight.class,
			PotionOfFrost.class,
			PotionOfPureDestruction.class,
			PotionOfNerveGas.class
	};
	...
	private static final HashMap<String, Integer> colors = new HashMap<String, Integer>() {
		{
			...
			put("lime",ItemSpriteSheet.POTION_Lime);
	...
	public void doThrow( final Hero hero ) {
		...
		if (isKnown() && (
			...
			this instanceof PotionOfPureDestruction ||
