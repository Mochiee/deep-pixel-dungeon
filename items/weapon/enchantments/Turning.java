...
public class Turning extends Weapon.Enchantment {

    private static ItemSprite.Glowing PINKRED = new ItemSprite.Glowing( 0xFF274C );
    ...
    public int proc( Weapon weapon, Char attacker, Char defender, int damage ) {
        ...
        if (Random.Int( level + 8 ) >= 7) {
            ...
            Buff.prolong( defender, Amok.class, Random.Float( 1, 2.7f + level ) );
