...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.mochi.deeppixeldungeon.messages.actors.actors",
			"com.mochi.deeppixeldungeon.messages.items.items",
			"com.mochi.deeppixeldungeon.messages.levels.levels",
			"com.mochi.deeppixeldungeon.messages.plants.plants",
			"com.mochi.deeppixeldungeon.messages.scenes.scenes",
			"com.mochi.deeppixeldungeon.messages.ui.ui",
			"com.mochi.deeppixeldungeon.messages.windows.windows",
			"com.mochi.deeppixeldungeon.messages.misc.misc"
	};

	static{
		setup(DeepPixelDungeon.language());
	}
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.mochi.deeppixeldungeon.", "");
			key += "." + k;
		} else
			key = k;
