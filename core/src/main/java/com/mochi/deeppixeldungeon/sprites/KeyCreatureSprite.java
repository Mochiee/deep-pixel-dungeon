...
import com.mochi.deeppixeldungeon.actors.mobs.KeyCreature;
import com.mochi.deeppixeldungeon.effects.MagicMissile;
import com.watabou.noosa.TextureFilm;
import com.watabou.noosa.audio.Sample;
import com.watabou.utils.Callback;

public class KeyCreatureSprite extends MobSprite {

    public KeyCreatureSprite() {
        super();

        texture( Assets.KeyCreature );
