...
public class ShamanLeaderSprite extends MobSprite {

    private int cellToAttack;

    public ShamanLeaderSprite() {
        super();

        texture( Assets.ShamanLeader );

        TextureFilm frames = new TextureFilm( texture, 30, 19 );
    ...
    public void zap( int pos ) {
        ...
        parent.add( new Lightning( ch.pos, pos, (ShamanLeader)ch ) );
