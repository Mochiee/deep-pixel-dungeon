...
public class ItemSpriteSheet {
	...
	public static final int BELTED_CHEST    = CONTAINERS+8;
	public static final int ELVEN_CHEST     = CONTAINERS+7;
	public static final int DEMONIC_CHEST   = CONTAINERS+9;
    ...
    public static final int ROUGH_KEY       = SINGLE_USE+15;
    public static final int ELVEN_KEY       = SINGLE_USE+16;
    public static final int CURSED_KEY      = SINGLE_USE+17;
	                                                                                    //32 free slots

	private static final int WEP_TIER1      =                               xy(1, 7);   //8 slots
	public static final int WORN_SHORTSWORD = WEP_TIER1+0;
	public static final int SacrificialKnife= WEP_TIER1+1;
	public static final int KNUCKLEDUSTER   = WEP_TIER1+2;
    public static final int TheDebugger     = WEP_TIER1+3;
	...
	private static final int WEP_TIER3      =                               xy(1, 8);   //9 slots
	...
	public static final int Hex             = WEP_TIER3+6;
	...
	public static final int PinLuna         = WEP_TIER6+0;
	public static final int PinSol          = WEP_TIER6+1;
	public static final int Aegis           = WEP_TIER6+2;
	public static final int Sorrowblade     = WEP_TIER6+3;
    ...
    public static final int Cards           = MISSILE_WEP+7;
    public static final int ShadowShard     = MISSILE_WEP+8;
    ...
    public static final int POTION_Lime     = POTIONS+12;
    public static final int POTION_Pink     = POTIONS+13;
    ...
    public static final int SpiritsChalice= FOOD+9;
