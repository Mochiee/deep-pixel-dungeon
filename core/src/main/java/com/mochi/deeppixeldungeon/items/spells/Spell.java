...
package com.mochi.deeppixeldungeon.items.spells;
        ...
        import com.mochi.deeppixeldungeon.actors.buffs.SoulMark;
        ...
        import com.mochi.deeppixeldungeon.scenes.CellSelector;
...
public abstract class Spell extends Item {
    ...
    protected Spell.Charger charger;
    ...
    protected abstract void onCast( Ballistica attack );
    ...
    public String info() {
        ...
        if (cursed && cursedKnown)
            desc += "\n\n" + Messages.get(Spell.class, "cursed");
    ...
    protected int initialCharges() { return Cooldown; }
    ...
    protected void SpellUsed() {
        usagesToKnow -= cursed ? 1 : chargesPerCast();
        curCharges -= cursed ? 1 : chargesPerCast();
        if (!isIdentified() && usagesToKnow <= 0) {
            identify();
            GLog.w( Messages.get(Spell.class, "identify", name()) );
        } else {
    ...
    protected static CellSelector.Listener zapper = new  CellSelector.Listener() {
        ...
        public void onSelect( Integer target ) {
            ...
            if (target != null) {
                ...
                if (curSpell.curCharges >= curSpell.maxCharges) {

                    curUser.busy();

                    curSpell.fx(shot, new Callback() {
                        public void call() {
                            curSpell.onCast(shot);
                            curSpell.SpellUsed();
                        }
                    });
                }
                ...
                GLog.w( Messages.get(com.mochi.deeppixeldungeon.items.wands.Wand.class, "fizzles") );
        ...
        public String prompt() {
            return Messages.get(com.mochi.deeppixeldungeon.items.wands.Wand.class, "prompt");
        }
    };
    ...
    public class Charger extends Buff {
        ...
        private static final float BASE_CHARGE_DELAY = 0.5f;
