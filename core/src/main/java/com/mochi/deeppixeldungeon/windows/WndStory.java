...
import com.mochi.deeppixeldungeon.Chrome;
...
public class WndStory extends Window {
    ...
    public static final int ID_FOREST       = 0;
	public static final int ID_SEWERS		= 1;
	public static final int ID_PRISON		= 2;
	public static final int ID_CAVES		= 3;
	public static final int ID_CITY     	= 4;
    public static final int ID_CITYCASTLE   = 5;
	public static final int ID_HALLS		= 6;
	public static final int ID_CAVESANNEX   = 7;
	...
	static {
        ...
        CHAPTERS.put( ID_CAVESANNEX, "cavesannex");
		CHAPTERS.put( ID_CITY, "city" );
        CHAPTERS.put( ID_CITYCASTLE, "citycastle" );
	...
	public WndStory( String text ) {
		...
		tf.maxWidth(DeepPixelDungeon.landscape() ?
					WIDTH_L - MARGIN * 2:
					WIDTH_P - MARGIN *2);
		tf.invert();
		tf.setPos(MARGIN, 0);
