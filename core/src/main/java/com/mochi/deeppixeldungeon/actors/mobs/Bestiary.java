...
public class Bestiary {
	...
	private static Class<?> mobClass( int depth ) {
		...
		case 1:
			chances = new float[]{ 5 };
			classes = new Class<?>[]{Spirit.class};
			break;
		case 2:
			chances = new float[]{ 1, 1, 1, 1 };
			classes = new Class<?>[]{ GnollThief.class, GnollMarksman.class, GnollKnight.class, Mandrake.class };
			break;
		case 3:
			chances = new float[]{ 1, 1, 1, 1 };
			classes = new Class<?>[]{ GnollThief.class, GnollMarksman.class, GnollKnight.class, Mandrake.class };
        ...
        case 5:
            chances = new float[]{ 1 };
            classes = new Class<?>[]{ Mandrake.class };
         break;
			
		case 6:
			chances = new float[]{ 1 };
			classes = new Class<?>[]{ FlyingCat.class };
			break;
        case 7:
