...
import com.mochi.deeppixeldungeon.actors.blobs.GooWarn;
...
import com.mochi.deeppixeldungeon.sprites.SewerMobSprites.GooSprite;
...
public class Goo extends Mob {
	...
	public int damageRoll() {
		int min = 1;
		int max = (HP*2 <= HT) ? 15*Modifier : 10*Modifier;
		if (pumpedUp > 0) {
			pumpedUp = 0;
