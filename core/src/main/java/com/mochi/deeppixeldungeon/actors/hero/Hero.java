...
import com.mochi.deeppixeldungeon.GamesInProgress;
...
import com.mochi.deeppixeldungeon.actors.buffs.Bless;
import com.mochi.deeppixeldungeon.actors.buffs.Buff;
import com.mochi.deeppixeldungeon.actors.buffs.Combo;
import com.mochi.deeppixeldungeon.actors.buffs.Drowsy;
import com.mochi.deeppixeldungeon.actors.buffs.Fury;
...
import com.mochi.deeppixeldungeon.actors.buffs.Regeneration;
import com.mochi.deeppixeldungeon.actors.buffs.SnipersMark;
...
import com.mochi.deeppixeldungeon.effects.CheckedCell;
import com.mochi.deeppixeldungeon.effects.Flare;
import com.mochi.deeppixeldungeon.effects.Speck;
import com.mochi.deeppixeldungeon.items.Amulet;
...
import com.mochi.deeppixeldungeon.items.armor.glyphs.AntiMagic;
import com.mochi.deeppixeldungeon.items.armor.glyphs.Flow;
import com.mochi.deeppixeldungeon.items.armor.glyphs.Obfuscation;
import com.mochi.deeppixeldungeon.items.armor.glyphs.Stone;
import com.mochi.deeppixeldungeon.items.armor.glyphs.Swiftness;
import com.mochi.deeppixeldungeon.items.armor.glyphs.Viscosity;
...
import com.mochi.deeppixeldungeon.items.keys.Key;
...
import com.mochi.deeppixeldungeon.items.weapon.missiles.MissileWeapon;
import com.mochi.deeppixeldungeon.levels.Level;
import com.mochi.deeppixeldungeon.levels.Terrain;
import com.mochi.deeppixeldungeon.levels.features.AlchemyPot;
import com.mochi.deeppixeldungeon.levels.features.Chasm;
import com.mochi.deeppixeldungeon.levels.features.Sign;
...
import com.mochi.deeppixeldungeon.scenes.SurfaceScene;
...
import com.mochi.deeppixeldungeon.windows.WndResurrect;
...
public class Hero extends Char {
	...
	public int STARTING_MAG = 10;
	
	private int attackSkill = 10;
	private int defenseSkill = 5;

    public static int CritChance = 2;
    public static int CritDamage = 2;
	...
	private static final String MAGIC	    = "MAG";
	...
	public boolean act() {
        ...
        //Crit chance cap is 50% chance. Strikeshot gets extra.
        //if (CritChance>50){
            //CritChance=51;
        //}
	...
	private boolean actOpenChest( HeroAction.OpenChest action ) {
        ...
        if (Dungeon.level.adjacent(pos, dst) || pos == dst) {
            ...
            if (heap != null && (heap.type != Type.HEAP && heap.type != Type.FOR_SALE)) {
                ...
                if (heap.type == Type.BELTED_CHEST
                        ) {

                    theKey = belongings.getItem(RoughKey.class);
                    ...
                    if (heap.type == Type.ELVEN_CHEST
                            ) {

						theKey = belongings.getItem(ElvenKey.class);
                ...
                if (heap.type == Type.DEMONIC_CHEST
                        ) {

					theKey = belongings.getItem(CursedKey.class);
	...
	public int attackProc( Char enemy, int damage ) {
        ...
        if (Random.Int(100)<CritChance) {
            if (wep != null) damage = wep.proc(this, enemy, damage)*CritDamage;
            sprite.showStatus( CharSprite.DEFAULT, Messages.get(this, "crit") );

        } else {
            if (wep != null) damage = wep.proc(this, enemy, damage);
        }

        if (rangedWeapon != null && Random.Int(100) < CritChance)
             damage = rangedWeapon.proc(this, enemy, damage) * (CritDamage);
	...
	public void onOperateComplete() {
		...
		if (curAction instanceof HeroAction.Unlock) {
			...
			if (heap.type == Type.SKELETON || heap.type == Type.REMAINS) {
				...
				belongings.chestkeytier1[Dungeon.chest]--;
			}
			StatusPane.needsKeyUpdate = true;
			heap.open( this );
		}
