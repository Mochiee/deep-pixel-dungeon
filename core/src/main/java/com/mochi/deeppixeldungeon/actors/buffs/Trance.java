...
import com.mochi.deeppixeldungeon.items.BrokenSeal.WarriorShield;
...
public class Trance extends Buff {

    private enum State{
        NORMAL, EXHAUSTED, RECOVERING, TRANCE;
    }
    ...
    public boolean berserking(){
        ...
        return state == State.TRANCE && target.SHLD > 0;
    }
