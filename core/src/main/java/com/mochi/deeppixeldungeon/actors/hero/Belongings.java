...
import com.mochi.deeppixeldungeon.items.spells.BuffSpell;
...
public class Belongings implements Iterable<Item> {
	...
	public int[] chestkeytier1 = new int[26]; //golden or boss keys
	...
	private static final String CHEST_KEY_TIER1 = "chestkeytier1";
	...
	public void storeInBundle( Bundle bundle ) {
		...
		bundle.put( CHEST_KEY_TIER1, chestkeytier1);
	}
	...
	public int charge( float charge ) {
		...
		for (Wand.Charger charger : owner.buffs(Wand.Charger.class)) {
			...
			for (BuffSpell.Charger buff : owner.buffs(BuffSpell.Charger.class)) {
				buff.gainCharge(charge);

				for (Spell.Charger spell : owner.buffs(Spell.Charger.class)) {
					spell.gainCharge(charge);
