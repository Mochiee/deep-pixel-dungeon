...
import com.mochi.deeppixeldungeon.actors.buffs.Awareness;
...
import com.mochi.deeppixeldungeon.actors.mobs.GnollNinja1;
import com.mochi.deeppixeldungeon.actors.mobs.GnollNinja2;
import com.mochi.deeppixeldungeon.actors.mobs.npcs.Blacksmith;
import com.mochi.deeppixeldungeon.actors.mobs.npcs.Ghost;
import com.mochi.deeppixeldungeon.actors.mobs.npcs.Imp;
import com.mochi.deeppixeldungeon.actors.mobs.npcs.RatKing;
...
import com.mochi.deeppixeldungeon.levels.CavesAnnex;
import com.mochi.deeppixeldungeon.levels.CavesBossLevel;
import com.mochi.deeppixeldungeon.levels.CavesLevel;
import com.mochi.deeppixeldungeon.levels.CityBossLevel;
import com.mochi.deeppixeldungeon.levels.CityLevel;
import com.mochi.deeppixeldungeon.levels.DeadEndLevel;
import com.mochi.deeppixeldungeon.levels.ForestLevel;
import com.mochi.deeppixeldungeon.levels.HallsBossLevel;
import com.mochi.deeppixeldungeon.levels.HallsLevel;
import com.mochi.deeppixeldungeon.levels.LastShopLevel;
import com.mochi.deeppixeldungeon.levels.Level;
import com.mochi.deeppixeldungeon.levels.PrisonBossLevel;
import com.mochi.deeppixeldungeon.levels.PrisonLevel;
...
import com.mochi.deeppixeldungeon.scenes.StartScene;
import com.mochi.deeppixeldungeon.ui.QuickSlotButton;
import com.mochi.deeppixeldungeon.utils.BArray;
import com.mochi.deeppixeldungeon.utils.DungeonSeed;
...
public class Dungeon {
	...
	public static void init() {
		...
		challenges = DeepPixelDungeon.challenges();
		...
		Imp.Quest.reset();
		GnollNinja1.Quest.reset();
		GnollNinja1.Quest.reset(); GnollNinja2.Quest.reset();
	...
	public static Level PipesLevel() {
	...
	public static Level CavesAnnex() {
	...
	public static void loadGame( String fileName, boolean fullLoad ) throws IOException {
		...
		if (fullLoad) {
			...
			if (!quests.isNull()) {
                ...
                GnollNinja1.Quest.restoreFromBundle(quests); GnollNinja2.Quest.restoreFromBundle(quests);
			} else {
				Ghost.Quest.reset();
				Wandmaker.Quest.reset();
				Blacksmith.Quest.reset();
