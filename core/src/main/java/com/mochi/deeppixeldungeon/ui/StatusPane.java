...
import com.mochi.deeppixeldungeon.windows.WndJournal;
...
public class StatusPane extends Component {
	...
	protected void createChildren() {
        ...
        mpImage = new Image( Assets.MP_BAR );
        add( mpImage );
	...
	public void update() {
        ...
        float mp = Dungeon.hero.MP;
        float mpCap = Dungeon.hero.MPcap;
        ...
        mpImage.scale.x = Math.max( 0, mp/mpCap);
