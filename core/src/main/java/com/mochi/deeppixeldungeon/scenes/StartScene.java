...
import com.mochi.deeppixeldungeon.effects.BannerSprites.Type;
import com.mochi.deeppixeldungeon.effects.Speck;
import com.mochi.deeppixeldungeon.messages.Messages;
import com.mochi.deeppixeldungeon.ui.Archs;
import com.mochi.deeppixeldungeon.ui.ExitButton;
import com.mochi.deeppixeldungeon.ui.Icons;
import com.mochi.deeppixeldungeon.ui.RedButton;
import com.mochi.deeppixeldungeon.ui.RenderedTextMultiline;
import com.mochi.deeppixeldungeon.windows.WndChallenges;
import com.mochi.deeppixeldungeon.windows.WndClass;
...
public class StartScene extends PixelScene {
	...
	public void create() {
		...
		curClass = null;
		updateClass( HeroClass.values()[DeepPixelDungeon.lastClass()] );
		...
		Badges.loadingListener = new Callback() {
			...
			public void call() {
				if (Game.scene() == StartScene.this) {
					DeepPixelDungeon.switchNoFade( StartScene.class );
				}
			}
		};
	}
	...
	private void startNewGame() {
		...
		if (DeepPixelDungeon.intro()) {
			DeepPixelDungeon.intro( false );
	...
	protected void onBackPressed() {
		DeepPixelDungeon.switchNoFade( TitleScene.class );
	}
	...
	private class ChallengeButton extends Button {
		...
		protected void createChildren() {
			...
			image = Icons.get( DeepPixelDungeon.challenges() > 0 ? Icons.CHALLENGE_ON :Icons.CHALLENGE_OFF );
			add( image );
		}
		...
		protected void onClick() {
			if (Badges.isUnlocked( Badges.Badge.VICTORY )) {
				StartScene.this.add(new WndChallenges(DeepPixelDungeon.challenges(), true) {
					public void onBackPressed() {
						super.onBackPressed();
						image.copy( Icons.get( DeepPixelDungeon.challenges() > 0 ?
