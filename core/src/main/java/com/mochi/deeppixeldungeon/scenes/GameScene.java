...
import com.mochi.deeppixeldungeon.effects.BannerSprites;
import com.mochi.deeppixeldungeon.effects.BlobEmitter;
import com.mochi.deeppixeldungeon.effects.EmoIcon;
import com.mochi.deeppixeldungeon.effects.Flare;
import com.mochi.deeppixeldungeon.effects.FloatingText;
import com.mochi.deeppixeldungeon.effects.Ripple;
...
import com.mochi.deeppixeldungeon.sprites.MiscMobsSprites.DiscardedItemSprite;
import com.mochi.deeppixeldungeon.sprites.MiscMobsSprites.HeroSprite;
import com.mochi.deeppixeldungeon.sprites.MiscMobsSprites.ItemSprite;
import com.mochi.deeppixeldungeon.tiles.CustomTiledVisual;
import com.mochi.deeppixeldungeon.tiles.DungeonTerrainTilemap;
import com.mochi.deeppixeldungeon.tiles.DungeonTileSheet;
import com.mochi.deeppixeldungeon.tiles.DungeonTilemap;
import com.mochi.deeppixeldungeon.tiles.DungeonWallsTilemap;
import com.mochi.deeppixeldungeon.tiles.FogOfWar;
import com.mochi.deeppixeldungeon.tiles.GridTileMap;
import com.mochi.deeppixeldungeon.tiles.TerrainFeaturesTilemap;
import com.mochi.deeppixeldungeon.tiles.WallBlockingTilemap;
import com.mochi.deeppixeldungeon.ui.ActionIndicator;
import com.mochi.deeppixeldungeon.ui.AttackIndicator;
import com.mochi.deeppixeldungeon.ui.Banner;
import com.mochi.deeppixeldungeon.ui.BusyIndicator;
import com.mochi.deeppixeldungeon.ui.GameLog;
import com.mochi.deeppixeldungeon.ui.HealthIndicator;
import com.mochi.deeppixeldungeon.ui.LootIndicator;
import com.mochi.deeppixeldungeon.ui.QuickSlotButton;
import com.mochi.deeppixeldungeon.ui.ResumeIndicator;
import com.mochi.deeppixeldungeon.ui.StatusPane;
import com.mochi.deeppixeldungeon.ui.Toast;
import com.mochi.deeppixeldungeon.ui.Toolbar;
...
import com.mochi.deeppixeldungeon.windows.WndBag.Mode;
import com.mochi.deeppixeldungeon.windows.WndGame;
import com.mochi.deeppixeldungeon.windows.WndHero;
import com.mochi.deeppixeldungeon.windows.WndInfoCell;
import com.mochi.deeppixeldungeon.windows.WndInfoItem;
import com.mochi.deeppixeldungeon.windows.WndInfoMob;
import com.mochi.deeppixeldungeon.windows.WndInfoPlant;
import com.mochi.deeppixeldungeon.windows.WndInfoTrap;
...
import com.mochi.deeppixeldungeon.windows.WndTradeItem;
...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		Music.INSTANCE.volume( DeepPixelDungeon.musicVol()/10f );

		DeepPixelDungeon.lastClass(Dungeon.hero.heroClass.ordinal());
		
		super.create();
		Camera.main.zoom( GameMath.gate(minZoom, defaultZoom + DeepPixelDungeon.zoom(), maxZoom));
	...
	public static void layoutTags() {
		...
		float tagLeft = DeepPixelDungeon.flipTags() ? 0 : uiCamera.width - scene.attack.width();

		if (DeepPixelDungeon.flipTags()) {
