...
public class AboutScene extends PixelScene {
	...
	public void create() {
		...
		final float colWidth = Camera.main.width / (DeepPixelDungeon.landscape() ? 2 : 1);
		final float colTop = (Camera.main.height / 2) - (DeepPixelDungeon.landscape() ? 30 : 90);
		final float wataOffset = DeepPixelDungeon.landscape() ? colWidth : 0;
		...
		wata.y = DeepPixelDungeon.landscape() ?
						colTop:
