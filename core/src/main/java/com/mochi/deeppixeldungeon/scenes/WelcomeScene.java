...
import com.mochi.deeppixeldungeon.Rankings;
...
public class WelcomeScene extends PixelScene {
	...
	public void create() {
		...
		final int previousVersion = DeepPixelDungeon.version();

		if (DeepPixelDungeon.versionCode == previousVersion) {
		...
		DarkRedButton okay = new DarkRedButton(Messages.get(this, "continue")){
			...
			protected void onClick() {
				...
				DeepPixelDungeon.switchScene(TitleScene.class);
			}
		};
		...
		if (previousVersion != 0){
			DarkRedButton changes = new DarkRedButton(Messages.get(this, "changelist")){
				...
				protected void onClick() {
					super.onClick();
					updateVersion(previousVersion);
					DeepPixelDungeon.switchScene(ChangesScene.class);
				}
			};
		...
		} else if (previousVersion <= DeepPixelDungeon.versionCode) {
	...
	private void updateVersion(int previousVersion){
		//rankings conversion
		if (previousVersion <= DeepPixelDungeon.v0_4_1){
			try {
		...
		DeepPixelDungeon.version(DeepPixelDungeon.versionCode);
	}
