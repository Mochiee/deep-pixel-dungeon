...
import com.mochi.deeppixeldungeon.effects.Fireball;
import com.mochi.deeppixeldungeon.messages.Messages;
import com.mochi.deeppixeldungeon.ui.Archs;
import com.mochi.deeppixeldungeon.ui.ChangesButton;
import com.mochi.deeppixeldungeon.ui.ExitButton;
import com.mochi.deeppixeldungeon.ui.LanguageButton;
import com.mochi.deeppixeldungeon.ui.PrefsButton;
	...
	public void create() {
		...
		DashboardItem btnBadges = new DashboardItem( Messages.get(this, "badges"), 3 ) {
			...
			protected void onClick() {
				DeepPixelDungeon.switchNoFade( BadgesScene.class );
			}
		};
		add(btnBadges);
		...
		DashboardItem btnAbout = new DashboardItem( Messages.get(this, "about"), 1 ) {
			@Override
			protected void onClick() { DeepPixelDungeon.switchNoFade( AboutScene.class );
			}
		};
		add( btnAbout );
		...
		DashboardItem btnRankings = new DashboardItem( Messages.get(this, "rankings"), 2 ) {
			@Override
			protected void onClick() {
				DeepPixelDungeon.switchNoFade( RankingsScene.class );
			}
		};
		add( btnRankings );
