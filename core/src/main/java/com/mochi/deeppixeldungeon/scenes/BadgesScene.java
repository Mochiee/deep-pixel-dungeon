...
import com.mochi.deeppixeldungeon.effects.BadgeBanner;
...
import com.mochi.deeppixeldungeon.windows.WndBadge;
...
public class BadgesScene extends PixelScene {
	...
	public void create() {
		...
		float pw = Math.min( w, (DeepPixelDungeon.landscape() ? MIN_WIDTH_L : MIN_WIDTH_P) * 3 ) - 16;
		float ph = Math.min( h, (DeepPixelDungeon.landscape() ? MIN_HEIGHT_L : MIN_HEIGHT_P) * 3 ) - 32;
