...
public class Assets {
	...
	public static final String SHADOW_MOB = "shadow_mob.png";
	public static final String DirkMimic = "DirkMimic.png";
	public static final String Idol = "idol.png";
	public static final String DarkRat = "DarkRat.png";
    public static final String Sludge = "Sludge.png";
	public static final String Goolem = "Goolem.png";
	public static final String LesserRat = "LesserRat.png";
	public static final String Terminator = "Terminator.png";
	public static final String Assassin = "Assassin.png";
	public static final String GNOLLMARKSMAN = "GnollMarksMan.png";
	public static final String GnollKnight = "GnollKnight.png";
	public static final String Mandrake = "Mandrake.png";
	public static final String GangBoss = "GangBoss.png";
	public static final String Gangster = "Gangster.png";
	public static final String FlyingCat = "FlyingCat.png";
	public static final String GnollThief = "GnollThief.png";
	public static final String Grieflord = "Grieflord.png";
	public static final String KeyCreature = "KeyCreature.png";
	public static final String RedMushroom = "RedMushroom.png";
	public static final String PurpleMushroom = "PurpleMushroom.png";
	public static final String ShamanLeader = "shamanleader.png";
	public static final String YellowMushroom = "YellowMushroom.png";
	public static final String ElderShroom = "ElderShroom.png";
	public static final String Goblin = "Goblin.png";
	public static final String Ghost = "Spirit.png";
	...
	public static final String TILES_CAVESANNEX = "tiles5.png";
	public static final String TILES_GNOLL = "tiles7.png";
	public static final String TILES_FOREST = "tiles8.png";
