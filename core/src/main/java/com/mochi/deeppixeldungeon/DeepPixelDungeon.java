...
public class DeepPixelDungeon extends Game {
	...
	public DeepPixelDungeon() {
		...
		com.watabou.utils.Bundle.addAlias(
				com.mochi.deeppixeldungeon.levels.rooms.special.MassGraveRoom.Bones.class,
				"com.mochi.deeppixeldungeon.levels.painters.MassGravePainter$Bones" );
		com.watabou.utils.Bundle.addAlias(
				com.mochi.deeppixeldungeon.levels.rooms.standard.RitualSiteRoom.RitualMarker.class,
				"com.mochi.deeppixeldungeon.levels.painters.RitualSitePainter$RitualMarker" );
		com.watabou.utils.Bundle.addAlias(
				com.mochi.deeppixeldungeon.levels.rooms.special.WeakFloorRoom.HiddenWell.class,
				"com.mochi.deeppixeldungeon.levels.painters.WeakFloorPainter$HiddenWell" );
		com.watabou.utils.Bundle.addAlias(
				com.mochi.deeppixeldungeon.levels.rooms.Room.class,
				"com.mochi.deeppixeldungeon.levels.Room" );
		com.watabou.utils.Bundle.addAlias(
				com.mochi.deeppixeldungeon.items.weapon.melee.Shortsword.class,
				"com.mochi.deeppixeldungeon.items.weapon.melee.NewShortsword" );

		//v0.6.0a
		com.watabou.utils.Bundle.addAlias(
				com.mochi.deeppixeldungeon.items.food.SmallRation.class,
				"com.mochi.deeppixeldungeon.items.food.OverpricedRation" );
		...
		com.watabou.utils.Bundle.exceptionReporter =
				new com.watabou.utils.Bundle.BundleExceptionCallback() {
					...
					public void call(Throwable t) {
						DeepPixelDungeon.reportException(t);
					}
				};
	...
	public static void landscape( boolean value ) {
		...
		((DeepPixelDungeon)instance).updateDisplaySize();
	}
	...
	public static void immerse( boolean value ) {
		...
		instance.runOnUiThread( new Runnable() {
			...
			public void run() {
				...
				((DeepPixelDungeon)instance).view.getHolder().setSizeFromLayout();
			}
		} );
	}
